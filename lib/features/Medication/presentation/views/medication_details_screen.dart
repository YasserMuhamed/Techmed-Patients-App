...
class _MedicationDetailsScreenState extends State<MedicationDetailsScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(
          S.of(context).medication_details,
      ...
      floatingActionButton: DecoratedBox(
        ...
        child: TextButton.icon(
              ...
              builder: (context) {
                return BlocProvider(
                  ...
                  child: AlertDialog(
                    ...
                    content: Text(
                      S.of(context).delete_medication_confirmation,
                        ...
                        listener: (context, state) {
                          if (state is MedicationDeleteSuccess) {
                            ToastHelper.showSuccessToast(
                              context,
                              S.of(context).medication_deleted_successfully,
                            );
          ...
          label: Text(
            S.of(context).delete_medication,
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        32.verticalSpace,
        Text(
          medication.notes ?? S.of(context).no_notes_available,
          style: AppTextStyles.poppins16Regular(context),
        ),
      ],
    );
